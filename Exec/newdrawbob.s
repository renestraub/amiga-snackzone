...
.EndLoop:
		...
		mulu.w	NumPlanes,d1		; Länge einer BobPlane*Anzahl Bitmaps des Bildes
		move.l	d1,d0
...
JeqFunc:	move.l	2(a2,d1.w),a3
		btst	#SRB_ZEROFLAG,bob_sr(A0)
		beq.s	1$
		sub.l	a2,a3
		move.w	a3,d1
		bra	ReturnNull4
